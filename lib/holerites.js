// Importa direto do build CJS (não a raiz do pacote) — o pdf-lib tem duas
// versões internas, e o processo de build do Next.js/Vercel às vezes escolhe
// a versão ESM por engano, o que quebra tudo. Isso força a versão certa.
