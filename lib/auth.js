...
// --- RH (agora com usuários individuais, cada um com login e senha próprios) ---
function criarSessaoRH(adminUsuario) {
  const token = jwt.sign(
    { id: adminUsuario.id, nome: adminUsuario.nome, tipo: 'rh' },
    SECRET,
    { expiresIn: '30d' }
  );
